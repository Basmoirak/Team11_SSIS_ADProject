namespace Team11_SSIS_ADProject.Migrations
{
    ...
    public partial class SeedUsers : DbMigration
    {
        ...
        {
            Sql(@"
            INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [UserName], [DepartmentId]) VALUES (N'1', N'storeclerk@email.com', 0, N'AJ83R2/+Zj2sZ1s+vjMptCdhWbls9PllsNprQqhCbsxzTlIZzagMkB5/njIEgOwZ7w==', N'bb97d846-7e91-4b40-a1cd-94e996ffa47c', NULL, 0, 0, NULL, 1, 0, N'storeclerk@email.com', N'')
            INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [UserName], [DepartmentId]) VALUES (N'2', N'storesupervisor@email.com', 0, N'AJ83R2/+Zj2sZ1s+vjMptCdhWbls9PllsNprQqhCbsxzTlIZzagMkB5/njIEgOwZ7w==', N'bb97d846-7e91-4b40-a1cd-94e996ffa47c', NULL, 0, 0, NULL, 1, 0, N'storesupervisor@email.com', N'')
            INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [UserName], [DepartmentId]) VALUES (N'3', N'storemanager@email.com', 0, N'AJ83R2/+Zj2sZ1s+vjMptCdhWbls9PllsNprQqhCbsxzTlIZzagMkB5/njIEgOwZ7w==', N'bb97d846-7e91-4b40-a1cd-94e996ffa47c', NULL, 0, 0, NULL, 1, 0, N'storemanager@email.com', N'')
            ...
            INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [UserName], [DepartmentId]) VALUES (N'10', N'admin@email.com', 0, N'AJ83R2/+Zj2sZ1s+vjMptCdhWbls9PllsNprQqhCbsxzTlIZzagMkB5/njIEgOwZ7w==', N'467b70f2-2e2d-43b5-aa43-df05fb57d231', NULL, 0, 0, NULL, 1, 0, N'admin@email.com', N'')
